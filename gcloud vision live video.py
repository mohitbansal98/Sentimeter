...
while True:
	...
	for face in faces:
		...
		text = anger + "\n" + joy + "\n" + surprise + "\n" + sorrow
		x,y =vertices[0]
		cv2.putText(frame,anger,(x,y),font,0.5,(0, 0, 255),2,0) 
		cv2.putText(frame,joy,(x,y+GAP),font,0.5,(0, 0, 255),2,0) 
		cv2.putText(frame,surprise,(x,y+(2*GAP)),font,0.5,(0, 0, 255),2,0) 
		cv2.putText(frame,sorrow,(x,y+(3*GAP)),font,0.5,(0, 0, 255),2,0) 
	...
	cv2.putText(frame,"happy", (length+5,15), font, 0.5, (0,0,0),2,0)	
	...
	cv2.putText(frame,"intrigued", (length+5,57), font, 0.5, (0,0,0),2,0)
	# print(text)
	# print(vertices)
